...
export const DistanceTime = ({ distance, time }: DiatanceTimeProps) => {
  ...
  return (
    <div className="absolute z-10 top-2 right-2 w-[50%]">
            ...
            <AccordionContent>
              <div className="flex flex-col gap-4">
                ...
                <div className="flex gap-3 items-center  justify-between">
                  <h1 className="text-xl font-semibold w-[100px]">Distance </h1>
                ...
                {/* time */}
                <div className="flex gap-3 items-center  justify-between">
                  <h1 className="text-xl font-semibold w-[100px]">Time </h1>
                  <h1 className="text-xl font-semibold text-green-400">
                    - - - - - - - -
                  </h1>
                  <div className="flex gap-2 text-black bg-white p-2 rounded-lg font-medium w-[150px] justify-around ">
                    <h1> {(time * 0.000621371192).toFixed(2)} </h1>
